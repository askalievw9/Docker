...
class UserProfile(AbstractUser):
    ...
    user_role = models.CharField(max_length=16,choices=ROLE_CHOICES,default='simple')
...
class Hotel(models.Model):
    ...
    hotel_stars = models.PositiveSmallIntegerField(validators=[MinValueValidator(1),
                                                         MaxValueValidator(5)])
    hotel_video = models.FileField(upload_to='hotel-video/', null=True,blank=True)
...
class RoomImage(models.Model):
    ...
    room_images = models.ImageField(upload_to='room_image/')
